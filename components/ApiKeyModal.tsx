...
export const ApiKeyModal: React.FC<ApiKeyModalProps> = ({ t, onClose, onSave, currentKey }) => {
    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={handleSave}
            className="w-full bg-gray-900 text-white font-bold py-2 px-6 rounded-md hover:bg-gray-700 transition-colors"
          >
            {t('api_key_save')}
          </button>
        </div>
